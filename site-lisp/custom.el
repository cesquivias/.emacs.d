(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ace-window ox-reveal groovy-mode fish-mode monky yaml-mode racket-mode paredit markdown-mode magit js2-mode iy-go-to-char htmlize haskell-mode geiser deft cider android-mode))))
(custom-set-faces
